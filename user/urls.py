...
from .views import RegistrationAPIView, LoginAPIView, GetAllUser, ChangePasswordAPIView, ForgotPasswordAPIView, ResetPasswordAPIView, UserApprovalAPIView, GetVideoRevenue, GetLatestVideo
...
urlpatterns = [
    ...
    path('resetPassword/<str:uidb64>/<str:token>',
         ResetPasswordAPIView.as_view(), name='reset-password'),
    path('userApproval/<int:user_id>',
         UserApprovalAPIView.as_view(), name='user-approval'),
